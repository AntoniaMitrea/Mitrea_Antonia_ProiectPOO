...
public:
    ...
    Persoana(int s, string loc) {
        this->sex = s;
        this->loculNasterii = loc;
    }

    friend ostream& operator<<(ostream& consola, const Persoana& p) {
        consola << "Sex = " << p.sex;
        consola << "Locul nasterii = " << p.loculNasterii;
        return consola;
    }
...
public:
    ...
    Angajat(char s) : anAngajare(2015), Persoana(s) {
        this->nume = "Popescu Ion";
        this->pozitie = new char[strlen("Director") + 1];
        strcpy(this->pozitie, "Director");
        this->varsta = 50;
    ...
    Angajat(string nume, char* pozitie, int varsta, float salariu, const int an, char s, string loc) : anAngajare(an), Persoana(s, loc) {
        this->nume = nume;
        this->pozitie = new char[strlen(pozitie) + 1];
        strcpy(this->pozitie, pozitie);
        this->varsta = varsta;
...
int main()
{
    cout << "CLASELE:" << endl << "PERSOANA -> ANGAJAT -> ANGAJATUL LUNII" << endl << endl;
    ...
    cout << "CONSTRUCTOR CU TOTI PARAMETRII (INCLUSIV CEI DIN CLASA Persoana)" << endl;
    Angajat angajat5("Matei Ioana", pozitie, 40, 5000, 2017, 'F', "Ploiesti");
    cout << "Angajatul 5: " << endl;
    cout << "Sex = " << angajat5.getSex() << endl;
    cout << "Locul nasterii = " << angajat5.getLoculNasterii() << endl;
    cout << angajat5 << endl;
